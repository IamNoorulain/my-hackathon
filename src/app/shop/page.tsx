          ...
          <div className=" max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-8">
              <button className="flex items-center gap-2 hover:text-purple-600 transition-colors">
                <Image src="/images/filter-icon.png" alt="filter" width={20} height={20} /> 
                <span className="font-medium">Filter</span>
              </button>
              <div className="flex items-center gap-2 border-l border-[#9F9F9F] pl-8">
                <button className="hover:text-purple-600 transition-colors">
                <Image src='/images/dots-icon.png' alt='dots icon' width={20} height={20} /> 
                </button>
                <button className="hover:text-purple-600 transition-colors">
                <Image src="/images/list-icon.png" alt='list' width={20} height={20} />
                </button>
              </div>
            ...
            <div className="flex items-center gap-4 w-[95%] lg:w-full mx-auto">
              <div className="flex items-center gap-2">
                ...
                <select className="text-xs lg:text-base bg-transparent border border-[#9F9F9F] rounded px-4 py-1 focus:outline-none focus:border-purple-600">
                  <option >16</option>
                  <option >32</option>
                  <option >48</option>
                </select>
              ...
              {products.map((product) => (
                <div key={product._id} className="group flex-shrink-0 w-[280px] sm:w-auto">
                  <div className="relative bg-[#F4F5F7] rounded-sm overflow-hidden">
                    ...
                    <button 
                      className="w-48 bg-white text-purple-600 px-6 py-2 rounded-md hover:bg-purple-600 hover:text-white transition-colors duration-300"
                    ...
                    <Link 
                      ...
                      className="w-48 bg-purple-600 text-white px-6 py-2 rounded-md hover:bg-white hover:text-purple-600 transition-colors duration-300 text-center"
                    >
                      View Product
                    </Link>
                  </div>
            ...
            <button
              ...
              className={`min-w-[48px] h-12 flex items-center justify-center rounded-lg text-base transition-colors
                ${item.active 
                  ...
                  : 'bg-[#F9F1E7] text-black hover:bg-purple-600 hover:text-white'
                }`}
            >
