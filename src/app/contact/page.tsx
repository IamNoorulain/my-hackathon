  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 py-16 font-poppins">
      ...
      <div className="text-center mb-16 max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl text-purple-700 font-poppinsSemiBold mb-4">Get In Touch With Us</h1>
        <p className="text-gray-600 text-sm text-gray max-w-xl mx-auto">
          ...
          <form className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                type="text"
                placeholder="Abc"
                className="w-full px-3 py-5 border border-purple-500 rounded-lg"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full p-3 border border-purple-500 rounded-lg resize-none"
              />
            </div>

            <button 
              className="py-3 px-14 font-poppins text-xs bg-purple-600 hover:bg-purple-800 text-white rounded-lg"
            >
              Submit
            </button>
          </form>
