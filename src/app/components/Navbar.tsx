      ...
      <nav className="bg-white shadow-md font-poppins relative ">  
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            ...
            <div className="hidden md:flex md:items-center sm:space-x-8">
              <Link href="/" className="text-gray-800 hover:text-purple-600 px-3 py-2 text-base font-poppinsSemiBold">
                Home
              </Link>
              <Link href="/shop" className="text-gray-800 hover:text-purple-600 px-3 py-2 text-base font-poppinsSemiBold">
                Shop
              </Link>
              <Link href="/blog" className="text-gray-800 hover:text-purple-600 px-3 py-2 text-base font-poppinsSemiBold">
                Blog
              </Link>
              <Link href="/contact" className="text-gray-800 hover:text-purple-600 px-3 py-2 text-base font-poppinsSemiBold">
                Contact
              </Link>
            </div>
            ...
            <div className="flex items-center md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-800 hover:text-purple-600 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-500"
              >
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white " onClick={() => setIsMenuOpen(!isMenuOpen)}>
            <Link href="/" className="block px-3 py-2 text-base font-medium text-gray-800 hover:text-purple-600" onClick={() => setIsMenuOpen(false)}>
              Home
            </Link>
            <Link href="/shop" className="block px-3 py-2 text-base font-medium text-gray-800 hover:text-purple-600" onClick={() => setIsMenuOpen(false)}>
              Shop
            </Link>
            <Link href="/blog" className="block px-3 py-2 text-base font-medium text-gray-800 hover:text-purple-600" onClick={() => setIsMenuOpen(false)}>
              Blog
            </Link>
            <Link href="/contact" className="block px-3 py-2 text-base font-medium text-gray-800 hover:text-purple-600" onClick={() => setIsMenuOpen(false)}>
              Contact
            </Link>
