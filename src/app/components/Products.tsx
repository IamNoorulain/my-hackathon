    ...
    <section className="py-16 md:py-24 px-4 font-poppins">
      <div className="max-w-[85%] mx-auto">
              ...
              <div key={product._id} className="group flex-shrink-0 w-full sm:w-auto">
                <div className="relative bg-[#F4F5F7] rounded-lg overflow-hidden shadow-md transition-all duration-300 hover:shadow-lg">
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center space-y-4">
                    <button 
                      className="w-48 bg-white text-black px-6 py-2 rounded-md hover:bg-purple-600 hover:text-white transition-colors duration-300"
                    ...
                    <Link 
                      ...
                      className="w-48 bg-purple-700 text-white px-6 py-2 rounded-md hover:bg-white hover:text-black transition-colors duration-300 text-center"
                    >
                      View Product
                    </Link>
                  </div>
                  ...
                  {/* Badge */}
                  {product.badge && (
                    <div className={`absolute top-4 right-4 ${product.badge.color} text-purple-600 text-sm font-bold px-4 py-1 rounded-full`}>
                      {product.badge.text}
                    </div>
                  )}
                </div>
                ...
                <div className="mt-4 text-center">
                  ...
                  <div className="flex justify-center items-center gap-3">
                    <span className="text-purple-700 font-semibold">$ {(product.price || 0).toLocaleString()}</span>
        ...
        <div className="mt-16 text-center">
          <button className="border-2 border-purple-700 text-black px-8 py-3 rounded-md hover:bg-purple-600 hover:text-white transition-colors duration-300">
            Show More
          </button>
        </div>
      </div>
