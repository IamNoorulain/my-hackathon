      ...
      <div className="mx-auto max-w-[1280px]">
        <div className="grid gap-8 lg:grid-cols-3 lg:gap-6">
          ...
          <div className="flex flex-col justify-center">
            ...
            <button className="mt-8 w-fit bg-purple-600 px-8 py-3 font-poppins text-white transition-colors hover:bg-purple-800">
              Explore More
            </button>
          </div>
          ...
          <div className="relative">
            <div className="relative aspect-[3/4] w-full overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white p-6">
                ...
                <div className="mt-2 flex items-center justify-between">
                  ...
                  <button className="rounded-full bg-purple-600 p-3 text-white transition-colors hover:bg-purple-800">
            ...
            <div className="absolute -bottom-8 left-0 flex gap-2">
              <div className="h-2 w-4 rounded-full bg-purple-700"></div>
