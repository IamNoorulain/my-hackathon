      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="text-2xl">$. 2500.00</div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center border border-purple-700 rounded py-1 lg:py-2 text-xs">
                <button
              ...
              <button className=" px-4 lg:px-8  text-[0.6rem] lg:text-base border border-purple-700  rounded py-3">Add To Cart</button>
              <button  className="px-4 lg:px-8 text-[0.6rem] lg:text-base border border-purple-700  rounded py-3">+ Compare</button>
            </div>
          ...
          className={`text-xl pb-4 border-b-2 -mb-[1px] transition-colors ${
            activeTab === 'description'
             ? 'border-black text-gray'
              : 'border-transparent text-lightGray hover:text-purple-600'
          }`}
        >
          Description
        </button>
    ...
    <section className="py-16 md:py-24 px-4 font-poppins">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-purple-700 text-3xl md:text-4xl font-bold mb-4">
            Related Products
          </h2>
        </div>
              ...
              <div key={product.id} className="group flex-shrink-0 w-[280px] sm:w-auto">
                <div className="relative bg-[#F4F5F7] rounded-sm overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                      <button className="w-52 bg-white text-purple-700 px-10 py-3 rounded-lg hover:bg-purple-600 hover:text-white transition-colors duration-300">
                        Add to cart
                      </button>
                    </div>
                    <div className="absolute bottom-20 left-1/2 -translate-x-1/2 flex items-center gap-4 text-white">
                      <button className="flex items-center gap-2 hover:text-purple-700 transition-colors">
                ...
                <div className="mt-4 text-center">
                  ...
                  <div className="flex justify-center items-center gap-3">
                    <span className="text-purple-600 font-semibold">$ {product.price.toLocaleString()}</span>
        ...
        <div className="mt-16 text-center">
          <button className="border-2 border-purple-600 text-black px-8 py-3 hover:bg-purple-800 hover:text-white transition-colors duration-300 hover:rounded-2xl">
            Show More
          </button>
        </div>
      </div>
