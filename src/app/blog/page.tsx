  ...
  return (
    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center">
      <Image
        ...
        className="mb-0"
      />
      <h1 className="text-4xl font-semibold text-purple-700 mb-4">Blog</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr,350px] gap-8">
        ...
        <div className=''>
          <div className="space-y-6 mb-12">
            ...
            <Link 
              href="#" 
              className="inline-block text-black underline underline-offset-4 hover:text-purple-600"
            >
              Read more
            </Link>
          </div>
        ...
        <div className="space-y-8">
          ...
          <div className="relative">
            <input
              type="text"
              placeholder="Search"
              className="w-full p-3 pr-12 border rounded-lg border-purple-500"
            />
            ...
            <div className="space-y-3">
              {categories.map((category) => (
                <div key={category.name} className="flex justify-between items-center">
                  <Link href="#" className="text-gray hover:text-purple-600">
                    {category.name}
                  </Link>
