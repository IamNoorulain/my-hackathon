      ...
      <div className="relative h-[300px] w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <Image
            ...
            className="mb-0"
          />
          <h1 className="text-4xl text-purple-700 font-semibold mb-4">Product Comparison</h1>
      ...
      <div className="w-[96%] lg:w-full max-w-6xl mx-auto px-4 py-16 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 ">
          <div className="flex flex-col p-8 rounded-lg col-span-2 lg:col-span-1">
            ...
            <Link
              href="/products"
              className="text-black underline  underline-offset-4 hover:text-purple-600"
            >
              View More
            </Link>
          </div>
          ...
          <div className="flex justify-center lg:gap-8 col-span-2">
            <div className="flex flex-col p-6 rounded-lg ">
              ...
              <p className="text-purple-600 font-medium mb-2">$. 2500.00</p>
            ...
            <div className="flex flex-col p-6 rounded-lg ">
              ...
              <p className="text-purple-600 font-medium mb-2">$. 2200.00</p>
              <div className="flex items-center gap-2">
                <div className="flex">
                  {[1, 2, 3, 4].map((_, i) => (
                    <Star key={i} className="w-4 h-4 fill-yellow-400 text-yellow-400" />
          ...
          <div className="flex flex-col p-8 rounded-lg col-span-2 lg:col-span-1">
            ...
            <button
              ...
              className="bg-purple-600 w-60 lg:w-auto hover:bg-purple-800 text-white flex items-center gap-2 px-2 lg:px-3 py-2 rounded-md text-sm"
            >
              Choose a Product
