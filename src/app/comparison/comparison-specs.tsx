    ...
    const specifications = {
      ...
      product: {
        ...
        specs: [
          ...
          { label: "Color", product1: "purp-7bg-purple-700", product2: "Beige" },
          ...
          <div key={key} className=" pb-10">
            ...
            {key === "warranty" && (
              <div className="grid grid-cols-3 gap-6 items-center pt-6">
                ...
                <button className="py-3 w-36 bg-purple-700 hover:bg-purple-600 text-white font-poppins rounded text-sm">
                  Add To Cart
                </button>
                <button className="py-3 w-36 bg-purple-700 hover:bg-purple-600 text-white font-poppins rounded text-sm">
                  Add To Cart
